...
setup(
    ...
    name='arkouda_proxy_client',  # Required
    ...
    description='gRPC proxy for arkouda',  # Optional
    ...
    url='https://github.com/Bears-R-Us/arkouda-contrib/arkouda_proxy_client',  # Optional
    ...
    keywords='HPC workflow exploratory analysis parallel distribute arrays rust gRPC',  # Optional
    ...
    #
    packages=["arkouda_proxy_client"],  # Required
    ...
    project_urls={  # Optional
        ...
        'Source': 'https://github.com/Bears-R-Us/arkouda-contrib'
    },
)
